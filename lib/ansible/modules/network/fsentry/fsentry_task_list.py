...
DOCUMENTATION = '''
---
module: fsentry_task_lists
version_added: "2.4"
short_description: Manage forum sentry task lists.
description:
    - Create, update or delete a task list.
    - Import/export a task list.
options:
    description:
        description:
            - Description to be added to the object on the forum.
    enabled:
        description:
            - Should the task list be enabled on the forum.
        default: yes
        type: bool
...
RETURN = '''
state:
  description: current state of the task_list.
  returned: on success
  type: complex
  contains:
      status:
          ...
          sample:
              ...
              - deleted
      enabled:
            description: the enabled state of the object on the forum.
            ...
            sample:
                ...
                - false
      description:
            description: the description of the object on the forum.
            returned: when state is present
            type: str
      name:
            description: the name of the object on the forum.
