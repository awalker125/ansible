...
DOCUMENTATION = '''
---
module: fsentry_json_policy
version_added: "2.4"
short_description: Manage forum sentry JsonPolicy(s).
description:
    - Create, update or delete a JsonPolicy.
    - Import/export a JsonPolicy.
options:
    remote_path:
        description:
    ...
    description:
        description:
            - Description to be added to the JsonPolicy object on the forum.
...
RETURN = '''
state:
  description: current state of the JsonPolicy object.
  returned: on success
  type: complex
  contains:
      status:
...
class FSentryJsonPolicy(FSentryModuleBase):
...
#            [ 'enable_ssl' , 'true' , [ 'ssl_initiation_policy' ] ],
        ...
        super(FSentryJsonPolicy, self).__init__(self.module_arg_spec,
